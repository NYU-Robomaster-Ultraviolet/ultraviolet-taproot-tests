...
{
    leftSideOutput = tap::algorithms::limitVal<float>(leftSideOutput, -MAX_CURRENT_OUTPUT, MAX_CURRENT_OUTPUT);
    rightSideOutput = tap::algorithms::limitVal<float>(rightSideOutput, -MAX_CURRENT_OUTPUT, MAX_CURRENT_OUTPUT);
